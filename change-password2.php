...
$msg = "Change of password successful.";
if ($Conn)
                ...
                if ($Conn){
                    ...
                    if ($result->num_rows  > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo '<form action="change-password2.php" method="post">';
                                ...
                                echo '<div class="form-group">
                                      ...
                                      <div class="text-right">
                                            <button type = "submit" class = "btn btn-outline-dark"   name = "change_password" > Submit </button>
                                      </div>';
